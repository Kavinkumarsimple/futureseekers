        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">FutureSeekers website is easy to use and you can always contact us to solve your problems</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              ...
              <p class="description">FutureSeekers website will work 24/7 in a fast-paced manner.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
              ...
              <p class="description">You can access the FutureSeekers website anytime, anywhere.</p>
            </div>
          </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4">
            <div class="info-box  mb-4">
              ...
              <h3>Email Us</h3>
              <p>futureseekersnew@gmail.com</p>
            </div>
          </div>
