    ...
    <form action="<?php echo site_url('/AdminApplicantProfiles/verify') ?>" method="POST">
      ...
      <!-- <table>
        <tbody>
          ...
          $query = "Select t1.user_account_id, t1.name, t1.address, t1.email, t1.contactNo, t1.dob, t1.currentJobTitle, t2.username, t2.password
          ...
          ?>
            <tr>
              ...
              <td>
                <input type="checkbox" name="verify" id="verify" value="<?  ?>">
                <?php
